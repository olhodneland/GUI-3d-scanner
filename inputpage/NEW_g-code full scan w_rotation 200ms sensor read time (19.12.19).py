...
import sys
sys.stdout = open('/Users/oyvindlundehodneland/Desktop/full_scan_200ms_sensor_readtime.txt', 'w')          # Write all console output values to file, at this location.
